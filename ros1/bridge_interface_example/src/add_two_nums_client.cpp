...
int main(int argc, char* argv[]) {
    ...
    ros::ServiceClient client = nh.serviceClient<bridge_interface_example::AddTwoNums>("/add_two_nums");
    ...
    bridge_interface_example::AddTwoNums srv_call;
    bridge_interface_example::AddTwoNums::Request& req = srv_call.request;
    req.num1 = 2;
    req.num2 = 3.14;
